...
namespace Weapons
{
	namespace ak
	{
		std::vector<vector2> pattern =  { {-36, 55},{6, 46},{-55, 42},{-42, 37},{0, 33},{16, 28},{29, 24},{38, 19},{42, 14},{42, 9},{38, 9},{30, 18},{17, 25},{0, 29},{-15, 32},{-27, 33},{-37, 32},{-43, 29},{-46, 24},{-45, 17},{-42, 8},{-35, 5},{-24, 14},{-11, 21},{12, 25},{36, 28},{49, 28},{49, 26},{38, 21} };
	...
	namespace semi
	{
		std::vector<vector2> pattern = { {0,58},{0,58} }; //{ {0, -1.4} }, semi
		float delay = 150;
	}
	namespace m249
	{
		std::vector<vector2> pattern = { {0,37},{0,37} };
		float delay = 100;
	}
}